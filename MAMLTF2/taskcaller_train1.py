...
def taskcaller_train1 (filename, system_rate, k):
    ...
    x_train, t_train, x_val, t_val = train_test_split_meta1(x_seq, t_seq, k)
    return  x_train, t_train, x_val, t_val, input_nm, target_nm, data_length, DELAY_SIZE, train_eule_data, anticipation_size, train_time_data
