...
k_train = 300
n_eval = 100
xtask_train1, ytask_train1,xtask_val1,ytask_val1, dtrainx1, dtrainy1, dtestx1, dtesty1,input_nm, target_nm, data_length, DELAY_SIZE, train_eule_data, anticipation_size, train_time_data = taskcaller_train('../dataset/trainingtask1.csv', system_rate, k_train, n_eval)
